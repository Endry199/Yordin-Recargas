...
const robloxPackagesUSD = [
    { id: 1, name: '400 Robux', priceUSD: 4.99 },
    { id: 2, name: '800 Robux', priceUSD: 9.99 },
    { id: 3, name: '1,700 Robux', priceUSD: 19.99 },
    { id: 4, name: '4,500 Robux', priceUSD: 49.99 },
    { id: 5, name: '10,000 Robux', priceUSD: 99.99 }
];
